...
<body>
    ...
    <!-- end of navbar -->
    <h1 class="" style="text-align:center; color:white">-Update Goal-</h1>
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="db/update-goal.php">
                    <div class="md-3">
                        <label style="font-size:20px; color:white; font-weight:bold;" class="form-label">Goal Title:
                        </label>
                        <input value="<?php echo $post['goalTitle']; ?>" placeholder="Title" type="text"
                            style="color:white" class="form-control bg-dark" name="title">
                    </div>


                    <div class="md-3">
                        <br>
                        <label style="font-size:20px; color:white; font-weight:bold;" class="form-label">Goal
                            Description:
                        </label>
                    ...
                    <div class="md-3">
                        ...
                        <input name="date" value="<?php echo $post['goalAccomplishDate']; ?>" type="date"
                            style="color:white" class="form-control bg-dark">
                    </div>


                    <div class="md-3">
                        <label style="font-size:20px; color:white; font-weight:bold;" class="form-label">Status:</label>
                        <select name="status" class="form-control bg-dark" style="color:white">
